...
function addGamesToPage(games) {
    ...
    // Get the container where games will be added
    const gamesContainer = document.getElementById("games-container");
...
//Gets the total numbers of games
const totalGames = GAMES_JSON.length;

// create a string that explains the number of unfunded games using the ternary operator
const unfundedMessage = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} game${totalGames === 1 ? '' : 's'}. Currently, ${
    numUnfunded === 0
      ? 'all games have been funded. Thank you for your support! 🎉'
      : `${numUnfunded} game${numUnfunded === 1 ? '' : 's'} ${numUnfunded === 1 ? 'remains' : 'remain'} unfunded. We need your help to fund these amazing games!`
  }`;
